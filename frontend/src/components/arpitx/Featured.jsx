      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        <Reveal delay={100}>
          <h2 className="font-display uppercase text-5xl md:text-6xl lg:text-7xl leading-[0.9] tracking-tight text-white max-w-4xl">
            The debut <br />
            <span className="text-[#FF3D00]">feature.</span>
          </h2>
        </Reveal>
        ...
        <div className="mt-12 lg:mt-16 grid grid-cols-12 gap-6 lg:gap-10 items-start">
          ...
          <div className="col-span-12 lg:col-span-8">
            <Reveal delay={150}>
              <button
                ...
                className="group relative w-full aspect-video bg-black corner-frame border border-[rgba(255,255,255,0.08)] hover:border-[#FF3D00]/70 transition-all duration-500 overflow-hidden"
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative">
                    <div className="absolute inset-0 rounded-full bg-[#FF3D00] blur-xl opacity-40 group-hover:opacity-80 transition-opacity" />
                    <div className="relative w-20 h-20 lg:w-28 lg:h-28 rounded-full bg-[#FF3D00] flex items-center justify-center shadow-[0_0_60px_-5px_rgba(255,61,0,0.6)] group-hover:scale-110 transition-transform">
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      ...
                      <div className="mt-3 flex items-center gap-3 font-condensed uppercase text-[10px] lg:text-xs tracking-[0.3em] text-white/70">
                        <span className="text-[#FF3D00]">● DOC</span>
                        <span>·</span>
                        <span>Feature</span>
                        <span>·</span>
          ...
          <div className="col-span-12 lg:col-span-4">
            <Reveal delay={250}>
              <div className="border-l-2 border-[#FF3D00] pl-6 py-2">
                <div className="font-condensed uppercase text-xs tracking-[0.3em] text-[#FF3D00] mb-3">
                  Case File · 001
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-8 inline-flex items-center gap-2 font-condensed uppercase text-xs tracking-[0.3em] text-white hover:text-[#FF3D00] transition-colors"
                >
                  Watch on YouTube →
                </a>
              </div>
