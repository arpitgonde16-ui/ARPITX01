      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        <Reveal delay={100}>
          <h2 className="font-display uppercase text-5xl md:text-6xl lg:text-7xl leading-[0.9] tracking-tight text-white max-w-5xl">
            What I can <br /> <span className="text-[#FF3D00]">do</span> for you.
          </h2>
        </Reveal>
          ...
          {services.map((s, i) => (
            <Reveal key={i} delay={i * 60}>
              <div
                ...
                className="group relative h-full bg-[#111111]/80 backdrop-blur border border-[rgba(255,255,255,0.08)] p-8 lg:p-10 transition-all duration-500 hover:border-[#FF3D00]/60 hover:-translate-y-1 hover:shadow-[0_20px_60px_-10px_rgba(255,61,0,0.35)] cursor-default overflow-hidden"
              >
                {/* index label */}
                <div className="absolute top-6 right-6 font-condensed text-[10px] tracking-[0.3em] text-[#333] group-hover:text-[#FF3D00] transition-colors">
                ...
                <h3 className="font-display uppercase text-xl lg:text-2xl text-white leading-tight mb-3 group-hover:text-[#FFB800] transition-colors">
                  {s.title}
                </h3>
                ...
                {/* bottom line */}
                <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-[#FF3D00] transition-all duration-500 group-hover:w-full" />
              </div>
            </Reveal>
          ))}
        </div>
